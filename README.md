...
Coverage of the full Slack Web API (non-admin), in [reference](https://docs.slack.dev/reference/methods/) order. **better-slack-mcp** is our tool name (`-` = not yet implemented; our names mirror the method); **korotovsky** is korotovsky/slack-mcp-server's name where it maps 1:1 (`-` = none). 14 of 205 implemented.

> korotovsky also ships `users_search`, `conversations_unreads`, `usergroups_me`, and `saved_*` (the last are browser-token only); these have no single Slack method, so they are not in the table.
...
| 56  | `chat.postMessage`                            | `-`                     | `conversations_add_message`     |
...
| 72  | `conversations.info`                          | `conversations_info`    | `-`                             |
| 73  | `conversations.invite`                        | `-`                     | `-`                             |
| 74  | `conversations.inviteShared`                  | `-`                     | `-`                             |
| 75  | `conversations.join`                          | `-`                     | `conversations_join`            |
| 76  | `conversations.kick`                          | `-`                     | `-`                             |
| 77  | `conversations.leave`                         | `-`                     | `conversations_leave`           |
| 78  | `conversations.list`                          | `conversations_list`    | `channels_list`                 |
| 79  | `conversations.listConnectInvites`            | `-`                     | `-`                             |
| 80  | `conversations.mark`                          | `-`                     | `conversations_mark`            |
| 81  | `conversations.members`                       | `conversations_members` | `-`                             |
...
| 133 | `pins.list`                                   | `-`                     | `-`                             |
| 134 | `pins.remove`                                 | `-`                     | `-`                             |
| 135 | `reactions.add`                               | `-`                     | `reactions_add`                 |
| 136 | `reactions.get`                               | `-`                     | `-`                             |
| 137 | `reactions.list`                              | `-`                     | `-`                             |
| 138 | `reactions.remove`                            | `-`                     | `reactions_remove`              |
| 139 | `reminders.add`                               | `-`                     | `-`                             |
...
| 169 | `team.info`                                   | `team_info`             | `-`                             |
| 170 | `team.integrationLogs`                        | `-`                     | `-`                             |
| 171 | `team.preferences.list`                       | `-`                     | `-`                             |
| 172 | `team.profile.get`                            | `-`                     | `-`                             |
| 173 | `tooling.tokens.rotate`                       | `-`                     | `-`                             |
| 174 | `usergroups.create`                           | `-`                     | `usergroups_create`             |
| 175 | `usergroups.disable`                          | `-`                     | `-`                             |
| 176 | `usergroups.enable`                           | `-`                     | `-`                             |
| 177 | `usergroups.list`                             | `-`                     | `usergroups_list`               |
| 178 | `usergroups.update`                           | `-`                     | `usergroups_update`             |
| 179 | `usergroups.users.list`                       | `-`                     | `-`                             |
| 180 | `usergroups.users.update`                     | `-`                     | `usergroups_users_update`       |
...
| 185 | `users.identity`                              | `-`                     | `-`                             |
| 186 | `users.info`                                  | `users_info`            | `-`                             |
| 187 | `users.list`                                  | `users_list`            | `-`                             |
| 188 | `users.lookupByEmail`                         | `users_lookupByEmail`   | `-`                             |
| 189 | `users.profile.get`                           | `users_profile_get`     | `-`                             |
